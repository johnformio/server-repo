  ...
  if (app.portalEnabled) {
    ...
    app.get('/config.js', (req, res) => {
      fs.readFile(`./portal/config.js`, 'utf8', (err, contents) => {
        ...
        res.send(
          contents.replace(
            /var sac = false;|var ssoLogout = '';|var sso = '';|var onPremise = false;|var ssoTeamsEnabled = false;|var oAuthM2MEnabled = false|var licenseId = '';|var reportingUI = false;|var esign = false;|var whitelabel = false;/gi,
            (matched) => {
