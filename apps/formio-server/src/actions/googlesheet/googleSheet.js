...
var SpreadsheetID, CLIENT_ID, CLIENT_SECRET, REFRESH_TOKEN, appName, jsonData, mapping_settings, worksheetName;
...
module.exports = function (router) {
	...
	var formio = router.formio,
		GoogleSheetAction = function (data, req, res) {
	...
	GoogleSheetAction.prototype.resolve = function (handler, method, req, res, next) {
		formio.hook.settings(req, function (err, settings) {
			...
			_.each(jsonData, function (value, key) {
				_.each(mapping_settings, function (val, k) {
					if (k === key) {
