...
module.exports = (analytics) => {
  ...
  analytics.formio.middleware.customCrmAction = require('../middleware/customCrmAction')(analytics.formio);
  ...
  router.put('/upgrade',
    ...
    analytics.formio.middleware.customCrmAction('upgradeproject')
  );
