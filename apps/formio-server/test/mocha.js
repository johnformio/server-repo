...
if (!docker && !customer) {
  ...
  .then(function(state) {
    app = state.app;
    hook = require(path.join(_formio, 'src/util/hook'))(app.formio.formio);
    ...
    after(function() {
      describe('Final Tests', function() {
        ...
        describe('Formio', function() {
          ...
          //  originalSettingsHook = app.formio.formio.hooks.settings;
          //  app.formio.formio.hooks.settings = require('./formioHooks.js')(_test).settings;
          //});

          // Set up formio specific hooks
          //var formioHook = require(path.join(_formio, 'src/util/hook'))({hooks: require('./formioHooks.js')(_test)});

          //require(path.join(_test, 'unit'))(app.formio, template, hook);
        ...
        describe('Formio-Server tests that depend on Formio tests', function() {
          before(function() {
            ...
            app.formio.formio.hooks.settings = originalSettingsHook;
          });
